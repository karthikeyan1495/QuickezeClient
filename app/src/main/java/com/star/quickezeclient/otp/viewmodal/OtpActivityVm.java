package com.star.quickezeclient.otp.viewmodal;
...
public class OtpActivityVm {
    ...
    public OtpActivityVm(Activity activity, ActivityOtpBinding binding) {
    ...
    private void callApi() {
        ...
        String otps=binding.otpone.getText().toString()+binding.otptwo.getText().toString()+binding.otpthree.getText().toString()+binding.otpfour.getText().toString();

        loginmodal.setMobile(MySession.getInstance(activity).getMobileNumber());
        loginmodal.setOtp(otps);
        ...
        if (InternetChecker.getInstance().isReachable()) {
            ...
            Observable<Response<GeneralResponse>> observable = api.otpsend(loginmodal);
